...
const tsmHistoricalSummaries: HistoricalReportSummary[] = [
  {
    ...
    bullFairValue: 428,
    summary: {
      en: 'Initial DeepValue pass treated TSM as a quality infrastructure asset with valuation support still clearly on our side.',
      'zh-TW':
  ...
  },
  {
    ...
    publishedAtMs: Date.UTC(2026, 1, 11),
    provenance: 'news-refresh',
    valuationStatus: 'cheap',
    thesisStatus: 'intact',
    ...
    bullFairValue: 434,
    summary: {
      en: 'Board capital approvals strengthened multi-year demand confidence, but pushed capex intensity higher than the easy bull framing allowed.',
      'zh-TW':
  ...
  },
  {
    ...
    publishedAtMs: Date.UTC(2026, 2, 10),
    provenance: 'scheduled-monitor',
    ...
    bullFairValue: 441,
    summary: {
      en: 'Monthly revenue confirmed the near-30% frame, but the stock rerated faster than fair value moved.',
      'zh-TW':
  ...
  },
  {
    ...
    publishedAtMs: Date.UTC(2026, 2, 16),
...
const tsmHistoricalDetails: Record<string, HistoricalReportDetail> = {
  ...
  'tsm-20260316-full-review': {
    ...
    monitorNext: [
      ...
      {
        en: 'Whether overseas fab ramp and N2 dilution land near the low or high end of management warning bands.',
